...
public:
		...
		: FSlateStyleSet("ImGuiStyle")
	{
		...
		Set("ImIcon.NiagaraProfiler", new IMAGE_BRUSH_SVG("Icons/Tools/imguiim_tool_niagara_profiler", Icon16x16));
		Set("ImIcon.TextureViewer", new IMAGE_BRUSH_SVG("Icons/Tools/im_tool_texture_viewer", Icon16x16));
